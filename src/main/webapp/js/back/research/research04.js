...
$(function () {
    ...
    doAjaxSyn(PROJECT_NAME + "/AreasInstrumentsController/findAreasInstrumentsByPojo.do", {instrumentId: "D01"}, function (data) {
        ...
        for (var i = 0; i < redata.length; i++) {
            html01 += '<option label="' + redata[i].province + '" value="'
                + redata[i].province + '">' + redata[i].province + '</option>';
        }
        ...
        var html02 = '';
        for (var i = 0; i < redata.length; i++) {
            html02 += '<option label="' + redata[i].extra + '" value="'
                + redata[i].extra + '">' + redata[i].extra + '</option>';
        }
        ...
        var html03 = '';
        for (var i = 0; i < redata.length; i++) {
            html03 += '<option label="' + redata[i].instrumentId + '" value="'
                + redata[i].instrumentId + '">' + redata[i].instrumentId + '</option>';
        }
